/*
  Unit tests for the create.js library (fuji testnet).
*/
...
describe('[FUJI] #CreateLib', () => {
  ...
  beforeEach(() => {
    ...
    const config = {
      ava: new Avalanche(localConfig.host, localConfig.port, localConfig.protocol, localConfig.networkID),
  ...
  describe('#fromMnemonic', () => {
    ...
    it('should return a formated walled with type mnemonic', async () => {
      try {
        ...
        assert.equal(
          wallet.address,
          'X-fuji1v6hutycdrl5xys8g2hxqxltktx5ty5j00tqeet'
        )
  ...
  describe('#fromPrivateKey', () => {
    ...
    it('should return a formated wallet with type privateKey', async () => {
      try {
        ...
        assert.equal(
          wallet.address,
          'X-fuji1u6pvrj20s7vjw0j9mc5ms2as7wdan77zxtpzxp'
        )
